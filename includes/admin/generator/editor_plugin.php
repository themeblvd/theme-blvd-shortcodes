...
$plugin_url = TB_SHORTCODES_PLUGIN_URI . '/includes/admin/generator/assets/images';
?>
(function(){

	var icon_url = '<?php echo $plugin_url; ?>' + '/tb-icon.png';
					...
					d.addCommand( "themeblvdOpenDialog",function(a,c){
						...
						jQuery.get(e+"/dialog.php",function(b){
							...
							switch ( themeblvdSelectedShortcodeType ) {
								...
								// tabs
								case 'tabs':
								a  = '[tabs style="framed" nav="tabs_above" height="300" tab_1="Title #1" tab_2="Title #2" tab_3="Title #3"]<br />';
								...
								tb_show("Insert Theme Blvd "+ themeblvdSelectedShortcodeTitle +" Shortcode", "#TB_inline?width="+f+"&height="+b+"&inlineId=themeblvd-dialog");jQuery("#themeblvd-shortcode-options h3:first").text(""+c.title+" Shortcode Settings");
