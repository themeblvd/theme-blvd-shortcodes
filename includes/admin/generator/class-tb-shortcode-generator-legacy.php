...
class Theme_Blvd_Shortcode_Generator_Legacy {
	...
	public function get_options( $type ) {
		...
		$options['column'] = array(
			...
			'col_1' => array(
				'id' 		=> 'col_1',
				'name'		=> __( 'Column #1', 'theme-blvd-shortcodes' ),
				'desc'		=> __( 'Configure the content for the first column.', 'theme-blvd-shortcodes' ),
				'std'		=> 'Column #1...',
				'type'		=> 'textarea',
			...
			'col_2' => array(
				'id' 		=> 'col_2',
				'name'		=> __( 'Column #2', 'theme-blvd-shortcodes' ),
				'desc'		=> __( 'Configure the content for the second column.', 'theme-blvd-shortcodes' ),
				'std'		=> 'Column #2...',
				'type'		=> 'textarea',
			...
			'col_3' => array(
				'id' 		=> 'col_3',
				'name'		=> __( 'Column #3', 'theme-blvd-shortcodes' ),
				'desc'		=> __( 'Configure the content for the third column.', 'theme-blvd-shortcodes' ),
				'std'		=> 'Column #3...',
				'type'		=> 'textarea',
			...
			'col_4' => array(
				'id' 		=> 'col_4',
				'name'		=> __( 'Column #4', 'theme-blvd-shortcodes' ),
				'desc'		=> __( 'Configure the content for the fourth column.', 'theme-blvd-shortcodes' ),
				'std'		=> 'Column #4...',
				'type'		=> 'textarea',
			...
			'col_5' => array(
				'id' 		=> 'col_5',
				'name'		=> __( 'Column #5', 'theme-blvd-shortcodes' ),
				'desc'		=> __( 'Configure the content for the fifth column.', 'theme-blvd-shortcodes' ),
				'std'		=> 'Column #5...',
				'type'		=> 'textarea',
